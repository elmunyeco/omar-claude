# Generated by Django 5.1.1 on 2025-01-27 20:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['fecha'], name='indicacione_fecha_b762b7_idx'), models.Index(fields=['historia_clinica'], name='indicacione_idHisto_248eeb_idx'), models.Index(fields=['historia_clinica', 'fecha'], name='indicacione_idHisto_0bf324_idx')],
            },
        ),
        migrations.AddIndex(
